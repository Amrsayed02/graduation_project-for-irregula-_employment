...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">بوابات الدفع /</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">جميع
                    بوابات الدفع</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal"
                        href="#modaldemo8">اضافة بوابة دفع</a>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    <th class="wd-15p border-bottom-0">رقم بوابة الدفع</th>
                                    <th class="wd-15p border-bottom-0">اسم بوابة الدفع</th>
                                    <th class="wd-15p border-bottom-0">صورة بوابة الدفع</th>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a class="modal-effect btn btn-sm btn-info btn-sm ml-2"
                                                    ...
                                                    data-arrange="{{ $catogery->arrange }}"data-is_home="{{ $catogery->is_home }}"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">اضافة بوابة دفع</h6><button aria-label="Close" class="close"
                            data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('payment_gateways.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <label for="exampleInputEmail1">اسم بوابة الدفع باللغه العربيه</label>
                                <input type="text" class="form-control" id="name_ar" name="name_ar" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">اسم بوابة الدفع باللغه الانجليزيه</label>
                                <input type="text" class="form-control" id="name_en" name="name_en" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">ترتيب بوابة الدفع </label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="key" id="key" class="form-control" required>
                                    ...
                                    <option value="fawaterak">فواتيرك</option>
                                    <option value="paymob_wallet">محفظة بايموب</option>
                                    <option value="paymob">بايموب</option>
                                    <option value="fawry">فوري</option>
                                    <option value="receipt_from_branch">استلام من الفرع</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="image">تحميل صوره للبوابة دفع </label>
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">تعديل بوابة الدفع</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('payment_gateways.update', 0) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="recipient-name" class="col-form-label">صوره بوابة الدفع</label>
            ...
            <div class="modal" id="modaldemo9">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">حذف بوابة الدفع</h6>
                            <button aria-label="Close" class="close" data-dismiss="modal" type="button">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form action="{{ route('payment_gateways.destroy', 0) }}" method="post">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                            <div class="modal-body">
    ...
    <script>
        $(document).ready(function() {
            $('.main-toggle').on('click', function() {
                ...
                var url = '{{ route('payment_gateways.update-status') }}';
