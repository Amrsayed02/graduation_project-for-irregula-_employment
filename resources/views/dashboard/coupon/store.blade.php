                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-lg">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input aria-label="Amount (to the nearest dollar)" class="form-control"
                                                placeholder="السعر" type="number" name="value" min="1" required>
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <select id="discount_type" name="discount_type" class="form-control SlectBox">

                                            <option value="fixed">سعر ثابت</option>
                                            <option value="percentage">نسبة مئويه</option>
