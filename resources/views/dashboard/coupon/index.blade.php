                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a class="modal-effect btn btn-sm btn-info btn-sm ml-2"
                                                    ...
                                                    data-code="{{ $coupon->code }}" data-value="{{ $coupon->value }}"
                    ...
                    <div class="modal-body">
                        <form action="{{ route('coupons.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-lg">
                                ...
                                <input class="form-control" placeholder="الكود"type="text" name="code" id="code"
                                    value="" required>
                            </div>
                            ...
                            <div class="col-lg">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input aria-label="Amount (to the nearest dollar)" class="form-control"
                                        placeholder="السعر" type="number" name="value" min="1" id="value"
                                        required>
