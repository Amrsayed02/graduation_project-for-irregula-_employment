...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/categories/import', [ProfessionController::class, 'import'])->name('categories.import');
    Route::post('/questions/import', [ServiceClassificationController::class, 'import'])->name('questions.import');
